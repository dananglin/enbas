...
func filterFunc(
	...
	switch cmd.Action {
	case cli.ActionShow:
		return filterShow(session.Client(), printSettings, cmd.FocusedTargetFlags)
	case cli.ActionCreate:
		return filterCreate(session.Client(), printSettings, cmd.FocusedTargetFlags)
	case cli.ActionEdit:
		return filterEdit(session.Client(), printSettings, cmd.FocusedTargetFlags)
	case cli.ActionDelete:
		return filterDelete(session.Client(), printSettings, cmd.FocusedTargetFlags)
	default:
